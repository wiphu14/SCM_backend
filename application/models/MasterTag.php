...
class MasterTag extends CI_Model { // คลาส Model_template สืบทอดคุณสมบัติของ CI_Model
    
	/**
	  * member
	  */
      private $tableName = "master_tag";
    ...
    * @return array
    ...
    public function getByTagNo($tag_no){
      $query = $this->db->where('tag_number',$id)->get($this->tableName);
      return $query->result();
    } // .End getByTagNo
