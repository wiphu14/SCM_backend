...
class Stamp extends MY_CI_Model { // คลาส Model_template สืบทอดคุณสมบัติของ CI_Model
    ...
    public function getByStampId($stamp_id){
        $query = $this->db->where('stamp_id',$stamp_id)->get($this->tblName);
        return $query->result();
    } // .end getById()
