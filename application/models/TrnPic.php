...
class TrnPic extends MY_CI_Model { // คลาส Model_template สืบทอดคุณสมบัติของ CI_Model
    
	/**
	  * member
	  */
      private $tableName = "trn_pic";
    ...
    * @return array
     ...
     * 
     */
    public function getByTrnCarInOutId($id){
      $query = $this->db->where('trn_car_in_out_id',$id)->get($this->tableName);
      return $query->result();
  } // .End getById
