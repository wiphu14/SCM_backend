                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?=site_url("welcome/authen_emp");?>" method="post">
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="text" id="username" placeholder="Enter Username..." name="username">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button class="btn btn-primary btn-block text-white btn-user my-2" style="font-size: .8rem; border-radius: 10rem; padding: .75rem 1rem;" onclick="PageRegister()">Register</button>
                                </div>
...
function PageRegister(){
    location.href = "<?=site_url("welcome/register");?>";
}
</script>