...
<body id="page-top">
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"><span>สมาชิกทั้งหมด</span></div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>จำนวนรถ</span></div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-info py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>จำนวนรถที่เข้าวันนี้</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $count = $this->trncarinout->countToday(); ?></span></div>
                                    </div>
                                    <div class="col-auto"><i class="fas fa-car fa-2x text-gray-300"></i></div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-danger py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-danger font-weight-bold text-xs mb-1"><span>จำนวนรถที่อยู่ข้างใน</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $count = $this->trncarinout->countIn(); ?></span></div>
                                    </div>
                                    <div class="col-auto"><i class="fas fa-car fa-2x text-gray-300"></i></div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row"> 
                                    ...
                                    <!-- <button class="btn btn-primary btn-sm" onclick="toDay();">รายวัน</button> -->
                                        <button class="btn btn-success btn-sm mr-2 onclick="toMonth();">รายเดือน</button>
                                    </div>
                                    <div class="col-mb">
                                    <?php $yr = date("Y") ?>
                                        <button type="button" class="btn btn-warning btn-sm" onclick="getYear(<?= $yr ?>);"> รายปี </button>
                                    </div>
                                    <div class="col-mb">
                                        <select class="form-control form-control-sm mr-2">
                                            <?php 
                                                $res = $this->trncarinout->gets();
                                                $year = array();
                                                $i = 0;
                                                foreach($res as $ar){
                                                    if($ar->time_out != NULL){
                                                ...
                                                foreach($y as $yr){
                                            ?>
                                            <option onchange="getYear(this)" id="year"><?php echo $yr; ?></option>
                                            <?php 
                                                }
                                            ?>
                                        </select>
    ...
    <footer class="bg-white sticky-footer">
        <div class="container my-auto">
            <div class="text-center my-auto copyright"><span>Copyright © DproV3 Management 2020</span></div>
        </div>
    </footer>
...
function toYear(year) {
    barChart.destroy();
    $.get("<?=site_url("welcome/forYear");?>").done((res)=>{
        console.log(res);
