    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Job Profile</h3>
                <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form  action="<?=site_url("welcome/addJob");?>" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="title"><strong>title</strong></label><input class="form-control" type="text" placeholder="title" name="title" id="title"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="is_open"><strong>is_open</strong></label><input class="form-control" type="text" placeholder="o" name="is_open" id="is_open"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="desc"><strong>description</strong></label><input class="form-control" type="text" placeholder="description" name="desc" id="desc"></div>
                                                </div>
                                            </div>
