                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form  action="<?=site_url("welcome/addGate");?>" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="cmd"><strong>คำสั่ง</strong></label><input class="form-control" type="text" placeholder="เปิด" name="cmd" id="cmd"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="gate_no"><strong>หมายเลขประตู</strong></label><input class="form-control" type="text" placeholder="0" name="gate_no" id="gate_no"></div>
                                                </div>
                                            </div>
