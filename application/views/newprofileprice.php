    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Profile Price</h3>
                <div class="row mb-3">
                    <div class="col-lg-12">
                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Profile Price Settings</p>
                                    </div>
                                    <div class="card-body">
                                        <form  action="<?=site_url("welcome/addProPrice");?>" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    <div class="form-group"><label for="h"><strong>เวลา</strong></label>                                                        
                                                        <select class="form-control" type="text" placeholder="1" name="h">
                                                        <?php
                                                        for ($i=0; $i<=24; $i++){
                                                        ?>
                                                            <option><?=$i?></option>
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="price"><strong>ราคา</strong></label><input class="form-control" type="text" placeholder="0" name="price"></div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group"><label for="for_member"><strong>ประเภทสมาชิก</strong></label><input class="form-control" type="text" placeholder="v" name="for_member"></div>
                                                </div>
                                            </div>
