                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Role Settings</p>
                                    </div>
                                    <div class="card-body">
                                        <form  action="<?=site_url("welcome/addRole");?>" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="card_number"><strong>ชื่อ</strong></label><input class="form-control" type="text" placeholder="aaa" name="name" id="name"></div>
                                                </div>
                                            </div>
