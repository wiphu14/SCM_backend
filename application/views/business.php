    ...
    <?php $this->load->view('nav'); ?>
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-10"><h3 class="text-dark mb-4">จัดการข้อมูลสมาชิก</h3></div>
                    <div class="col-sm-2"><button class="btn-success" onclick="PageAddBusiness()"><i class="fa fa-plus"></i> Add business</button></div>
                </div>
                        ...
                        aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <?php $res = $this->business->business();
                                    foreach ($res as $ar){
                                        ?>
                                        <tr>
                                            <td></td>
                                            ...
                                            <td><?php echo $ar->expire_date;?></td>
                                            <td><button class="btn" onclick="deleteById(<?=$ar->id;?>)"><i class="fa fa-trash"></i></button>
                                            <button class="btn" onclick="editBusiness(<?=$ar->id;?>)"><i class="fa fa-wrench"></i></button></td>
                                        </tr> 
                                    <?php
                                    }
                                    ?>
...
<script>
    ...
    function postDel(id){			
			$.post( "<?=site_url("welcome/deleteBusiness");?>", { 
    ...
    function postEdit(id){
        window.location = "<?=site_url("welcome/editBusiness/");?>"+id;	
    }
