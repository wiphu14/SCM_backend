    ...
    <?php $this->load->view('nav'); ?>
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-10"><h3 class="text-dark mb-4">จัดการประตู</h3></div>
                    <div class="col-sm-2"><button class="btn-success" onclick="PageAddGate()"><i class="fa fa-plus"></i> Add gate</button></div>
                </div>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">รายการประตู</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <tbody>
                                    ...
                                    foreach ($items as $item){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $item->gate_no;?></td>
                                            <td><?php echo $item->created_at;?></td>
                                            <td><button class="btn" onclick="deleteById(<?=$item->id;?>)"><i class="fa fa-trash"></i>
                                            <button class="btn" onclick="reset(<?=$item->id;?>)"><i class="fa fa-wrench"></i></button></td>
                                        </tr> 
                                    <?php
                                    }
                                    ?>
...
<script>
    ...
    function PageAddGate(){
        location.href = "<?=site_url("welcome/newgate");?>";
    }
    ...
    function deleteById(id){
        ...
        if(yn){
            postDel(id)
            location.href = "<?=site_url("welcome/gate");?>";
        }
    }

    function postDel(id){			
			$.post( "<?=site_url("welcome/deleteGate");?>", { 
    ...
    function postEdit(id){
        window.location = "<?=site_url("welcome/reset/");?>"+id;	
    }
