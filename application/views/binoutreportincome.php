                                ...
                                <div class="modal-body">
                                    ...
                                    <table >
                                        <tr>
                                            ...
                                            <tr>
                                                <td style="font-size:20px;">ประเภทรถ</td><td style="font-size:20px;" id="car_type"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="font-size:20px;">ค่าบริการ</td><td style="font-size:20px;" id="fee"></td>
                                            </tr>
                                        </table>
...
<script type="text/javascript">
        ...
        buttons: [
              
             {
                ...
                'ajax': {
                    'url':'<?=site_url('welcome/gets_business_trn_car_in_out_income_dt_json');?>/?business_id=<?=$business_id?>'
                },
                'columns': [
                    { data: 'id' }, 
                    { data: 'card_number' }, 
...
w.close();
	...
	function getDataStore() {
		$.get('<?=site_url('welcome/gets_business_trn_car_in_out_income_json');?>/?business_id=<?=$business_id?>',
        function(response){
  ...
  function renderDatatable() {
    ...
    function postSearch(){
        table.ajax.url('<?=site_url('welcome/search_business_trn_car_in_out_income_dt_json');?>/?business_id='+ $("#business_id").val() + '&date1=' + $("#date1").val() +"&date2=" + $("#date2").val()).load();
    }// .End postSearch
