...
<script type="text/javascript">
        ...
        buttons: [
              
             {
                ...
                'ajax': {
                    'url':'<?=site_url('welcome/gets_business_trn_car_in_out_dt_json');?>/?business_id=<?=$business_id?>'
                },
                'columns': [
                    { data: 'id' }, 
                    { data: 'card_number' }, 
	...
	function getDataStore() {
		$.get('<?=site_url('welcome/gets_business_trn_car_in_out_json');?>/?business_id=<?=$business_id?>',
        function(response){
