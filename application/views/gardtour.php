                                ...
                                <div class="modal-body">
                                    <div id="printDiv">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td width="160px;">No.</td><td id="print_trn_car_in_out_id"></td>
                                            </tr>
                                            <tr>
                                                <td width="160px;">วันเวลาเข้า</td><td id="print_in_date"></td>
                                            </tr>
                                            <tr>
                                                <td width="160px;">จุด</td><td id="print_out_date"></td>
                                            </tr>
                                            <tr>
                                                <td>เหตุการณ์</td><td id="print_reason"></td>
                                            </tr>
                                            <tr>
...
<script type="text/javascript">
        ...
        var myBusinessStore = {} // default data store;
            ...
            $(document).ready(function() {
             ...
             table = $('#datatable').DataTable({
				...
				'paging': true,
                'ajax': {
                    'url':'<?=site_url('event/gets_event_status_dt_json');?>'
                },
                'columns': [
                    { data: 'id' }, 
                    { data: 'business' }, 
    ...
    function viewEventInfo(el) {
        ...
        $("#print_event_status_id").html(myDataStore[index].event_status_id);
	...
	function getDataStore() {
		$.get('<?=site_url('event/gets_event_status_json');?>',
        function(response){
    ...
    $("#img_three").attr("src","<?=base_url();?>/public/assets/img/empty.png");
        ...
        function(response){
            ...
            if(response.success){
                ...
                if(trnPic.length > 0) {
                    $("#img_one").attr("src","<?=base_url();?>/uploads/event/" + trnPic[0].driver_file);
                }else{
                    $("#img_one").attr("src","<?=base_url();?>/public/assets/img/empty.png");
                }
                if(trnPic.length > 1) {
                    $("#img_two").attr("src","<?=base_url();?>/uploads/event/" + trnPic[1].driver_file);
                }else{
                    $("#img_two").attr("src","<?=base_url();?>/public/assets/img/empty.png");
                }
                if(trnPic.length > 2) {
                    $("#img_three").attr("src","<?=base_url();?>/uploads/event/" + trnPic[2].driver_file);
                }else{
                    $("#img_three").attr("src","<?=base_url();?>/public/assets/img/empty.png");
                }
