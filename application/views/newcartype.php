                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form  action="<?=site_url("welcome/addCarType");?>" method="post">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="card_number"><strong>ประเภทรถ</strong></label><input class="form-control" type="text" placeholder="00000000000" name="name" id="name"></div>
                                                </div>
                                            </div>
