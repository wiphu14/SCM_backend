    ...
    <?php $this->load->view('nav'); ?>
        <div class="d-flex flex-column" id="content-wrapper">            
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <form   action="<?=site_url("welcome/addStamp");?>" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card mb-3">
                                            <div class="card-body text-center shadow">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group text-left"><label for="site_id"><strong>Site ID</strong></label><input class="form-control" type="text" placeholder="" value="1" name="site_id" readonly></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group text-left"><label for="site_name"><strong>Site Name</strong></label><input class="form-control" type="text" placeholder="" value="Dpro" name="site_name" readonly></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group text-left"><label for="stamp_id"><strong>Stamp ID</strong></label><input class="form-control" id="stamp_id" type="text" placeholder="" value="<?php 
                                                            $year = date("Y");
                                                            $month = date("m");
                                                            $date = "c".$year.$month."0001";
                                                            echo $date;
                                                        ?>" name="stamp_id"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group text-left"><label for="stamp_title"><strong>Stamp Title</strong></label><input class="form-control" type="text" placeholder="" value="Dpro car" name="stamp_title"></div>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>        
                                                ...
                                                <div class="col-sm3 ml-3">
                                                    ...
                                                    <div class="row-left"> 
                                                        <div class="form-group row">
                                                            <input class="form-control col-8" style="font-size:12px;" type="text" placeholder="" name="time">
                                                            <div class="col-4" style="margin-top: 3px;"><label>Hr</label></div>
                                                        </div>
                                                    </div>
                                                    <div class="row-left"> 
                                                        <div class="form-group row">
                                                            <input class="form-control col-8" style="font-size:12px;" type="text" placeholder="" name="value">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <button class="btn" onclick="editStamp(<?= $item->id ?>)"><i class="fa fa-wrench"></i></button></button>
                                        </tr> 
                                    <?php
                                        }
                                    ?>
