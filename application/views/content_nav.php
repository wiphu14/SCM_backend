		...
		<ul class="nav navbar-nav flex-nowrap ml-auto">
			...
			<li class="nav-item dropdown no-arrow" role="presentation">
				<div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown"
						aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?=$this->session->userdata('fname');?></span><img class="border rounded-circle img-profile"
							src="<?=base_url();?>public/assets/img/logo/logo.jpg"></a>
					<div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
						
						<div class="dropdown-divider"></div><a class="dropdown-item" role="presentation" href="<?=site_url("welcome/signout");?>"><i
								class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;ออกจากระบบ</a>
					</div>
				</div>
			</li>
		</ul>
